...
function beratBadanPria() {
    ...
    document.write('Berat badan ideal pria untuk tinggi ', tinggiBadan, ' sentimeter adalah ',hasil,' kilogram');
}

function beratBadanWanita() {
    var hasil = (tinggiBadan - 100) - ((tinggiBadan - 100) * 0.15);
    document.write('Berat badan ideal wanita untuk tinggi ', tinggiBadan, ' sentimeter adalah ',hasil,' kilogram');
}